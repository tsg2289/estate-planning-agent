...
const TrustForm = ({ onSubmit }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="trust-form">
      ...
      {/* Co-Trustor Information (Optional) */}
      <div className="form-section">
        <h3>Co-Trustor Information (Optional)</h3>
        <div className="form-row">
          <div className="form-group">
        ...
        {formData.beneficiaries.map((beneficiary, index) => (
          <div key={index} className="beneficiary-item">
            ...
            <div className="form-row">
              ...
              <div className="form-group">
                <label className="form-label">Is Minor?</label>
                <select
                  value={beneficiary.isMinor}
                  onChange={(e) => handleBeneficiaryChange(index, 'isMinor', e.target.value === 'true')}
                  className="form-select"
                >
      ...
      <div className="form-section">
        ...
        <div className="form-group">
          ...
          <textarea
            ...
            onChange={handleInputChange}
            className="form-textarea"
            placeholder="Describe when and how trust assets should be distributed to beneficiaries..."
            required
          />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div className="form-group">
          ...
          <textarea
            ...
            onChange={handleInputChange}
            className="form-textarea"
            placeholder="Any additional terms, conditions, or special provisions for the trust..."
          />
        </div>
      </div>
